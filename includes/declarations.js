...
function src_asgm_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.src_emea_msp_assignment`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.src_nam_msp_assignment`
    }   
}

function intrmed_asgm_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.intrmed_emea_msp_assignment`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.intrmed_nam_msp_assignment`
    }   
}

function rpt_asgm_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.rpt_emea_msp_assignment`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.rpt_nam_msp_assignment`
    }   
}
...
function src_asgm_trend_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.src_emea_msp_assignment_trend`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.src_nam_msp_assignment_trend`
    }   
}

function intrmed_asgm_trend_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.intrmed_emea_msp_assignment_trend`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.intrmed_nam_msp_assignment_trend`
    }   
}

function rpt_asgm_trend_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.rpt_emea_msp_assignment_trend`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.rpt_nam_msp_assignment_trend`
    }   
}
...
function src_req_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.src_emea_msp_requisition`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.src_nam_msp_requisition`
    }   
}

function intrmed_req_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.intrmed_emea_msp_requisition`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.intrmed_nam_msp_requisition`
    }   
}

function rpt_req_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.rpt_emea_msp_requisition`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.rpt_nam_msp_requisition`
    }   
}
...
function src_candidate_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.src_emea_msp_candidate`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.src_nam_msp_candidate`
    }   
}

function intrmed_candidate_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.intrmed_emea_msp_candidate`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.intrmed_nam_msp_candidate`
    }   
}

function rpt_candidate_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.rpt_emea_msp_candidate`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.rpt_nam_msp_candidate`
    }   
}
...
function src_spend_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.src_emea_msp_spend`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.src_nam_msp_spend`
    }   
}

function intrmed_spend_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.intrmed_emea_msp_spend`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.intrmed_nam_msp_spend`
    }   
}

function rpt_spend_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.rpt_emea_msp_spend`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.rpt_nam_msp_spend`
    }   
}
...
function src_req_distribution_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.src_emea_msp_req_distribution`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.src_nam_msp_req_distribution`
    }   
}

function intrmed_1_req_distribution_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.intrmed_1_emea_msp_req_distribution`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.intrmed_1_nam_msp_req_distribution`
    }   
}

function intrmed_2_req_distribution_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.intrmed_2_emea_msp_req_distribution`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.intrmed_2_nam_msp_req_distribution`
    }   
}

function intrmed_3_req_distribution_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.intrmed_3_emea_msp_req_distribution`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.intrmed_3_nam_msp_req_distribution`
    }   
}

function intrmed_4_req_distribution_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.intrmed_4_emea_msp_req_distribution`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.intrmed_4_nam_msp_req_distribution`
    }   
}

function intrmed_5_req_distribution_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.intrmed_5_emea_msp_req_distribution`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.intrmed_5_nam_msp_req_distribution`
    }   
}

function rpt_req_distribution_tbl_name() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.rpt_emea_msp_req_distribution`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.rpt_nam_msp_req_distribution`
    }   
}
...
function tbl_execution_log() {
    if (dataform.projectConfig.defaultLocation == 'europe-west1'){
        return `delete_db_emea_cnsd_test.execution_logs`
    }
    else if (dataform.projectConfig.defaultLocation == 'us-east1') {
        return `delete_db_cnsd_test.execution_logs`
    }   
}
